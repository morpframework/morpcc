...
from ..app import App
from .model import (ObjectPermissionAssignmentCollection,
                    ObjectPermissionAssignmentModel)
#
from .modelui import (ObjectPermissionAssignmentCollectionUI,
...
@App.html(
    model=ModelUI, name="manage-permissions", template="master/permission/model.pt",
)
