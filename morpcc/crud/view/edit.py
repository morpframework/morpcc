...
@App.html(model=ModelUI, name='xattredit', template='master/crud/form.pt',
          permission=crudperms.Edit)
def xattredit(context, request):
    ...
    return {
        'page_title': 'Edit %s Extended Attributes' % html.escape(str(context.model.__class__.__name__)),
